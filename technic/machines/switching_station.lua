...
technic.register_machine("LV", "technic:switching_station", "SPECIAL")
technic.register_machine("MV", "technic:switching_station", "SPECIAL")
technic.register_machine("HV", "technic:switching_station", "SPECIAL")
