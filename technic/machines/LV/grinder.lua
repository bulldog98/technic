...
function technic.register_grinder_recipe(src, dst)
...
technic.register_machine("LV", "technic:grinder",        technic.receiver)
technic.register_machine("LV", "technic:grinder_active", technic.receiver)
